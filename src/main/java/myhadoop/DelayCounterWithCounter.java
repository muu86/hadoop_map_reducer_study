...
// Configured 를 상속, Tool 인터페이스를 구현한 클래스
// Tool 인터페이스를 구현한 드라이버 클래스는 ToolRunner 를 이용 실행
public class DelayCounterWithCounter 
	extends Configured 
	implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		if (otherArgs.length != 2) {
			System.err.println("Usage: DelayCounterWithConter <input> <output>");
			System.exit(2);
		}
